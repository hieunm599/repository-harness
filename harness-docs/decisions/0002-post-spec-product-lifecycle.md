...
Product docs under `harness-docs/product/`, story packets under `harness-docs/stories/`,
validation evidence in `harness-docs/TEST_MATRIX.md`, and decision records under
`harness-docs/decisions/` become the living operating surface.
