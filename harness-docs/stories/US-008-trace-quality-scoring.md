...
trace quality tiers in `harness-docs/TRACE_SPEC.md`.
...
- Scores minimal, standard, and detailed traces using `harness-docs/TRACE_SPEC.md`
...
`harness-docs/TRACE_SPEC.md` review guidance should reference the scoring command as
